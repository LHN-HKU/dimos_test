...
all_blueprints = {
    ...
    "sim-agentic": "dimos.simulation.dimsim.blueprints.agentic.sim_agentic:sim_agentic",
    "sim-basic": "dimos.simulation.dimsim.blueprints.basic.sim_basic:sim_basic",
    "sim-eval": "dimos.simulation.dimsim.blueprints.agentic.sim_eval:sim_eval",
    "sim-nav": "dimos.simulation.dimsim.blueprints.nav.sim_nav:sim_nav",
    "sim-parallel-eval": "dimos.simulation.dimsim.blueprints.agentic.sim_parallel_eval:sim_parallel_eval",
    "sim-spatial": "dimos.simulation.dimsim.blueprints.nav.sim_spatial:sim_spatial",
    "sim-temporal-memory": "dimos.simulation.dimsim.blueprints.agentic.sim_temporal_memory:sim_temporal_memory",
...
all_modules = {
    ...
    "dim-sim-adapter": "dimos.simulation.dimsim.adapter.DimSimAdapter",
    "dim-sim-bridge": "dimos.simulation.dimsim.bridge.DimSimBridge",
